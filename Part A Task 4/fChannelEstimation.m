...
maxPossibleDelay = length(goldseq)-1;
...
% Display the MUSIC Spectrum
figure(); contour(0:1:maxPossibleDelay, azimuths, abs(Zp));
ylabel("azimuths"); xlabel("Delay");
title("MUSIC Spectrum");

figure(); surf(0:1:maxPossibleDelay, azimuths, abs(Zp));
ylabel("azimuths"); xlabel("Delay"); zlabel("Cost");
title("MUSIC Spectrum");
